...
from baskets.views import add_to_basket, remove_from_basket, BasketTemplateView, BasketFormView, SuccessTemplateView

app_name = 'baskets'

urlpatterns = [
    path('current/', BasketTemplateView.as_view(), name='basket'),
